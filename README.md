...
- Cada reinvestimento com saldo de rendimentos libera um giro. Giros antigos fora dessa regra ficam cancelados; resultados já utilizados permanecem no histórico. Prêmios e probabilidades aguardam cadastro; nenhum prêmio foi inventado.
